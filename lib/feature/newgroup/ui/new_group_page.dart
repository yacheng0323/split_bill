...
class _NewGroupPageState extends ConsumerState<NewGroupPage> {
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(newGroupViewModelProvider);
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: memberNameController.text.isEmpty
                            ...
                            : () {
                                (state.members ?? [])
                                        .contains(memberNameController.text)
                                    ? ShowSnackBarHelper.errorSnackBar(
                                            context: context)
                                        .showSnackbar("Member already added")
                                    : ref
                                        .read(
                                            newGroupViewModelProvider.notifier)
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: IconButton(
                                      ...
                                      onPressed: () {
                                        ref
                                            .read(newGroupViewModelProvider
                                                .notifier)
                                            .removeMember(
                                                state.members?[index] ?? "");
                                      },
