...
class BillHomePage extends ConsumerStatefulWidget {
  const BillHomePage({super.key});

  @override
  ConsumerState<BillHomePage> createState() => _BillHomePageState();
}

class _BillHomePageState extends ConsumerState<BillHomePage>
  ...
  Widget build(BuildContext context) {
    final billHomeState = ref.watch(billHomeViewModelProvider);
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              "Split Bill",
              style:
                  TextGetter.headline6?.copyWith(fontWeight: FontWeight.w700),
            ),
          ),
          body: tables.isEmpty
              ? Center(
              ...
              : RefreshIndicator(
                  onRefresh: () async {
                    return ref.refresh(billHomeViewModelProvider.future);
                  },
                              ...
                              itemBuilder: (context, index) {
                                if (index == tables.length) {
                                  ...
                                  return GestureDetector(
                                    onTap: () {
                                      ref
                                          .read(billHomeViewModelProvider
                                              .notifier)
                              ...
                              children: [
                                ...
                                _buildBillList(
                                  ...
                                  onBillTapped: (bill) async {
                                    ...
                                    if (result == true) {
                                      ref.refresh(billHomeViewModelProvider);
                                    }
                                  },
                                ),
                              ],
          ...
          bottomNavigationBar: tables.isEmpty
              ? Container(
                  ...
                  child: SafeArea(
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        context.go(AppRoutes.Init_Group);
                      },
                      child: Text(
                        "Create A New Group",
                        style:
    ...
    child: debts.isEmpty
        ...
        : ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final textColor =
                  index % 2 == 0 ? BillColors.contentTextColor : Colors.white;
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: Text(
                        debt.debtor,
                        style: TextGetter.bodyText1?.copyWith(color: textColor),
...
Widget _buildBillList(List<BillModel> bills,
    {required Function(BillModel) onBillTapped}) {
  return Container(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Row(
                            children: bill.settledBy.map((settle) {
                              return Container(
...
class SpeedDialButton extends ConsumerWidget {
        ...
        ? SpeedDial(
            ...
            children: [
              SpeedDialChild(
                ...
                labelShadow: [],
                labelStyle: TextGetter.bodyText1?.copyWith(
                  color: Colors.white,
                  fontWeight: FontWeight.w700,
                ),
                onTap: () async {
                  final result = await context.pushNamed(
                    AppRoutes.New_Bill,
                    queryParameters: {"tableId": "$selectedTableId"},
                  );
                  if (result == true) {
                    onRefresh();
                  }
              ...
              SpeedDialChild(
                shape: const CircleBorder(),
                child:
                    const Icon(Icons.sentiment_satisfied_alt_rounded, size: 32),
                backgroundColor: BillColors.lightYellow,
                foregroundColor: BillColors.contentTextColor,
                label: "New Member",
                labelBackgroundColor: Colors.transparent,
      ...
      child: Container(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle:
                TextGetter.bodyText1?.copyWith(color: const Color(0xffAAAAAA)),
            contentPadding:
        ...
        children: [
          Expanded(
            child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.of(context).pop();
                DeleteGroupDialog.show(context, item);
              },
              child: Text(
                "Delete",
                style: TextGetter.bodyText1
            ...
            child: ElevatedButton(
              ...
              onPressed: () async {
                final result = await ref
                    .read(billHomeViewModelProvider.notifier)
                    .updateGroupName(titleController.text, item.id ?? 0);
                if (result.isSuccess) {
...
class DeleteGroupDialog extends ConsumerWidget {
  ...
  static Future<void> show(BuildContext context, GroupTableModel item) async {
    showDialog(
      context: context,
      builder: (context) => DeleteGroupDialog(item: item),
    );
  }
