...
class _NewBillPageState extends ConsumerState<NewBillPage> {
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(newBillViewModelProvider);

    return state.when(
      data: (data) {
        final members = data.members ?? [];
        final selectedList = data.settledMembers ?? [];
        return Scaffold(
                                ...
                                onTap: () {
                                  DatePicker.showDatePicker(
                                    ...
                                    onConfirm: (date) {
                                      ref
                                          .read(
                                              newBillViewModelProvider.notifier)
                                          .setDateTime(date);
                                      setState(() {
                                        dateController.text =
                                      ...
                                      return StatefulBuilder(
                                        builder: (context, setModalState) {
                                          final currentState = ref
                                              .watch(newBillViewModelProvider);
                                          return currentState.when(
                                            data: (currentData) {
                                              final currentSelectedList =
                                                  currentData.settledMembers ??
                                                      [];
                                              return SingleChildScrollView(
                                                child: Container(
                                                  alignment: Alignment.center,
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      if (formKey.currentState?.validate() ==
                                        ...
                                        final currentState =
                                            ref.read(newBillViewModelProvider);
